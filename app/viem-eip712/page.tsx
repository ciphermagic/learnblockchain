...
import EIP712Verifier_ABI from '@/abis/EIP712Verifier.json';

const CONTRACT_ADDRESS = '0x59b670e9fA9D0A427751Af201D676719a970857b' as Address;
...
export default function EIP712Demo() {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      {!account ? (
        <button onClick={connectWallet} className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mb-4'>
          连接钱包
        </button>
      ) : (
        <div className='space-y-4'>
          ...
          <div className='space-x-4'>
            <button onClick={handleSign} className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600'>
              签名
            </button>
