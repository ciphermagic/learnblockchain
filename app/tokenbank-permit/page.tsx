...
import { createPublicClient, createWalletClient, http, formatEther, getContract, custom, parseEther, Hex } from 'viem';
import { signTypedData } from 'viem/actions';
import { foundry } from 'viem/chains';
import TokenBank_ABI from '@/abis/TokenBank_Permit.json';

// PermitTokenBank 合约地址
const PERMIT_TOKEN_BANK_ADDRESS = '0x0E801D84Fa97b50751Dbf25036d067dCf18858bF';
...
export default function TokenBankPermitPage() {
  ...
  useEffect(() => {
    ...
    if (address) {
      fetchEthBalance().then(() => console.log('Eth Balance:', balance));
      fetchBalances().then(() => console.log('Balance:', balance));
    }
  }, [address, balance, fetchBalances, publicClient]);
